...
(function () {
  ...
  function renderDeal() {
    const deal = window.OpsData.getActiveDeal();
    const phaseLabels = ['Acquire', 'Permit', 'Build', 'C/O', 'Close'];
    ...
    body.innerHTML = `
      ...
      <div style="flex-shrink:0;">
        <div class="phase-track-head">
          ...
          <span class="count">Phase ${deal.phase} / 5</span>
        </div>
      ...
      <div style="flex:1;min-height:0;display:flex;flex-direction:column;">
        ...
        <textarea class="data-input" id="deal-notes" style="flex:1;min-height:60px;" placeholder="Deal notes…">${deal.notes || ''}</textarea>
      </div>
    `;
  }
